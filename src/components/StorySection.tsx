            ...
            <div className="w-full">
              <div className="text-center">
                <p className="text-hero-bg text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-relaxed">
                  Uma imobiliária com mais de 30 anos de mercado e menos de 10
                  corretores em uma cidade do interior conseguiu algo que
                  parecia impossível:{" "}
                  ...
                  <br />
                  <br />
                  Isso representa 160% de crescimento real – sem contratar mais
                  um monte de corretores, sem gastar fortunas em marketing, e
                  ainda por cima, se tornando uma das imobiliárias que mais paga
                  para o corretor.
                </p>
              </div>
            </div>
