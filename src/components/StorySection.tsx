  ...
  return (
    <>
      ...
      <div className="max-w-[1060px] mx-auto min-h-[400px] md:min-h-[750px] flex flex-col items-center relative py-6">
        ...
        <div className="relative md:absolute left-4 right-4 md:top-[100px] md:bottom-4 bg-hero-text rounded-[25px] md:rounded-[50px] shadow-sm p-6 md:p-12 lg:p-16 flex flex-col justify-center mt-8 md:mt-0">
          {/* Title */}
