...
const FAQSection = () => {
  return (
    <section className="relative bg-[#1A2329] font-raleway py-12 md:py-16 lg:py-20">
        <div className="absolute inset-0 bg-[#1A2329]"></div>
        <div className="max-w-[1897px] mx-auto px-4 md:px-6 lg:px-[418px]">
          <div className="max-w-[1060px] mx-auto flex flex-col justify-start items-center gap-8 md:gap-12 lg:gap-[60px]">
            ...
            <div className="w-full max-w-[360px] px-4 md:px-0">
              <Button 
                className="w-full h-[48px] md:h-[50px] bg-gradient-to-r from-[#C9A456] to-[#82652F] hover:from-[#B8943F] hover:to-[#71582A] text-[#000C14] font-bold text-sm md:text-base uppercase tracking-[1px] leading-4 rounded-[50px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)]"
                style={{
