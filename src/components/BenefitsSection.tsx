...
const BenefitsSection = () => {
  return (
    <>
      <section className="bg-hero-text px-4 md:px-6 lg:px-[418px] font-raleway rounded-t-[50px] lg:rounded-t-[100px] py-12 md:py-16 lg:py-20">
      <div className="max-w-[1060px] mx-auto flex flex-col items-center gap-8 md:gap-12 lg:gap-16 relative">
        ...
        <div className="w-full bg-hero-text rounded-[25px] lg:rounded-[50px] shadow-lg p-6 md:p-8 lg:p-12">
        ...
        <div className="w-full">
          ...
          <div className="flex flex-col gap-4 md:gap-5 lg:gap-6">
            ...
            <div className="w-full bg-gradient-to-r from-hero-bg/85 to-[rgba(0,26,43,0.85)] rounded-[10px] flex items-center p-4 md:p-6 lg:p-[30px] gap-4">
              <img src="/lovable-uploads/38101c22-9b26-419a-be30-66d520496d39.png" alt="Check icon" className="w-[24px] h-[24px] md:w-[28px] md:h-[28px] lg:w-[31px] lg:h-[30px] flex-shrink-0" />
