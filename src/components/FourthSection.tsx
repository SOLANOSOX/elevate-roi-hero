...
const FourthSection = () => {
  return (
    <section className="relative font-geist text-white">
      {/* Background */}
      <div
      ...
      >
        {/* Texto mais puxado para esquerda com responsividade */}
        <div className="w-full sm:w-11/12 md:w-4/5 lg:w-3/5 xl:w-1/2 flex flex-col gap-8 text-left lg:pl-12 xl:pl-16 2xl:pl-24">
          ...
          <div className="flex flex-col gap-6 text-sm sm:text-base md:text-lg lg:text-xl xl:text-[22px] leading-relaxed md:leading-loose">
            ...
            <p>
              Essa hesitação é comum, mas não pode te travar. Nós desmistificamos
              tudo. Este workshop é a prova de que o poder da IA e das vendas
              recorrentes está na{" "}
              <span className="font-bold text-hero-accent">simplicidade</span>,
              não na complexidade.
            </p>

            {/* Lista mais indentada */}
            <ul className="list-disc pl-6 sm:pl-8 md:pl-10 space-y-4 text-hero-accent/90">
              <li>
              ...
              <li>
                <span className="font-bold text-white">100% Aplicável:</span> Não
                importa o tamanho da sua imobiliária, seu nicho ou sua
